...
const SubCategoryAddModal = ({ setIsModalOpen }) => {
  ...
  const mutation = useMutation({
    mutationFn: async (formData) => {
      return postFetch(
        `${localurl}/subcategory/create?shopName=${sellerId.shopName}&categoryName=${formdata.category}`,
        formData
      );
    },
    onSuccess: () => {
  ...
  return (
    <section>
      <div>
        ...
        <div className="mt-6">
          <form className="flex flex-col gap-5" onSubmit={handleAddSubCategory}>
...
export default React.memo(SubCategoryAddModal);
